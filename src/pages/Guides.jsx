...
const DEFAULT_FILTERS = { search: '', city: 'all', language: 'all', specialty: 'all' };
...
function rowMatches(g, f) {
  ...
  if (f.specialty !== 'all') {
    ...
    if (specs.length > 0 && !specs.some(s => s.includes(f.specialty.toLowerCase()))) return false;
  }
  return true;
}

// ── Guide Card — DO NOT MODIFY ────────────────────────────────────────────────
